...
public class AutowiredAnnotationBeanPostProcessor extends InstantiationAwareBeanPostProcessorAdapter
	...
	public void postProcessMergedBeanDefinition(RootBeanDefinition beanDefinition, Class<?> beanType, String beanName) {
		// beanDefinition 是合并之后的bean
		// 检查哪些需要处理的资源(Autowire,通常理解中的@Autowire)
	...
	public PropertyValues postProcessPropertyValues(
		...
		// pvs是需要处理的属性
		// 找到postProcessMergedBeanDefinition处理好的对象
	...
	private InjectionMetadata findAutowiringMetadata(String beanName, Class<?> clazz, @Nullable PropertyValues pvs) {
		...
		String cacheKey = (StringUtils.hasLength(beanName) ? beanName : clazz.getName());//key就是bean的id，如果没有用全类名称
		// Quick check on the concurrent map first, with minimal locking.
	...
	private InjectionMetadata buildAutowiringMetadata(final Class<?> clazz) {
		...
		do {
			...
			ReflectionUtils.doWithLocalFields(targetClass, field -> {
				// 获取类上面标注了@Autowire 和 @Value 属性的对象。处理成 AutowiredFieldElement
